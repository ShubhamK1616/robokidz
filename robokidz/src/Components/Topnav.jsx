...
return(
        ...
        <div className='flex flex-wrap items-center px-9 shadow-lg shadow-[#3a3b451a] z-10' style={{height : "10%"}}>
              ...
              >              
               ...
               <input className=' mr-sm-2 py-1 px-2 rounded-l focus:border-blue-300 w-full outline-none border-2 focus:shadow-md hidden  lg:flex' type="search" placeholder="Search for..." aria-label="Search"></input>
               <button className='btn btn-primary border rounded bg-[#4e73df] py-1 px-2 items-end hidden  lg:flex'><SearchIcon className='text-white'/></button>
               <button className='flex lg:hidden btn btn-primary border rounded bg-[#4e73df] py-1 px-2 items-end ml-[70%] md:ml-0' onClick={(e)=>{e.preventDefault();setSearchBarOpenCloseState(!searchBarOpenCloseState)}}><SearchIcon className='text-white'/></button>
               </form>
               </div>
