            ...
            <div className='bg-[#f8f9fc] px-10 h-[80%]'>
             ...
             <div className='flex flex-col mt-10 justify-center items-center'>
               <div className='flex flex-col gap-y-4 w-full max-w-md'>
                <input className='p-2 md:p-4 text-xs md:text-base text-[#6e707e] border-[#d1d3e2] rounded-[10rem] focus:border-blue-300 outline-none border-2 focus:shadow-md' type="search" placeholder="Enter Serial No" aria-label="Search"></input>
